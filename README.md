[![Build Status](https://travis-ci.org/akalongman/sublimetext-FancyFormatter.svg?branch=master)](https://travis-ci.org/akalongman/sublimetext-FancyFormatter)

FancyFormatter
=============


FancyFormatter is a Sublime Text 2/3 plugin that supports format (beautify) source code.


FancyFormatter has support for the following languages:
...
[![PayPal donate button](https://www.paypalobjects.com/webstatic/en_US/btn/btn_donate_pp_142x27.png)](https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=akalongman@gmail.com&item_name=Donation%20to%20Sublime%20Text%20-%20FancyFormatter&item_number=1&no_shipping=1 "Donate to this project using Paypal")


Installing
----------
**With the Package Control plugin:** The easiest way to install FancyFormatter is through Package Control, which can be found at this site: http://wbond.net/sublime_packages/package_control

Once you install Package Control, restart Sublime Text and bring up the Command Palette (`Command+Shift+P` on OS X, `Control+Shift+P` on Linux/Windows). Select "Package Control: Install Package", wait while Package Control fetches the latest package list, then select FancyFormatter when the list appears. The advantage of using this method is that Package Control will automatically keep FancyFormatter up to date with the latest version.

**Without Git:** Download the latest source from [GitHub](https://github.com/akalongman/sublimetext-FancyFormatter) and copy the FancyFormatter folder to your Sublime Text "Packages" directory.

**With Git:** Clone the repository in your Sublime Text "Packages" directory:

    git clone https://github.com/akalongman/sublimetext-FancyFormatter.git FancyFormatter
...
To change the default configurations you have to update the **FancyFormatter - User Preferences** file. You can find this file in the Sublime Text menu bar under: `Sublime Text > Package Settings > FancyFormatter > Settings - User`. 

Make sure that you wrap all the configurations into a single root object.

```js
{
   "FancyFormatter_php_options": {...},
   "FancyFormatter_js_options": {...},
   ..
}
```
...
On Linux/OSx after installation of package, you must set chmod +x to file fmt.phar in folder %PACKAGESDIR%/FancyFormatter/FancyFormatter/lib/phpbeautifier

You can list all available transformations from Command Palette: FancyFormatter: Show PHP Transformations
Examples of many transformations can be found here: [PHP Transformation Examples](https://github.com/akalongman/sublimetext-FancyFormatter/blob/master/PHP-Transformations.md)
   ...
   "FancyFormatter_php_options":
    {
        ...
        // You can list all available transformations from command palette: FancyFormatter: Show PHP Transformations
        // You can also see examples of many transformations at https://github.com/akalongman/sublimetext-FancyFormatter/blob/master/PHP-Transformations.md
        "passes": [],
...
```js
    "FancyFormatter_python_options":
    {
        ...
        // constants without assigning them to a variables, but FancyFormatter
        ...
        // after all.  Normal FancyFormatter behavior will be still to include them
        ...
        // When FancyFormatter splits longer lines because max_seps
...
Language specific options:
```js
    "FancyFormatter_vbscript_options":
    {
...
Language specific options:
```js
    "FancyFormatter_coldfusion_options":
    {
...
If you like living on the edge, please report any bugs you find on the [FancyFormatter issues](https://github.com/akalongman/sublimetext-FancyFormatter/issues) page.
